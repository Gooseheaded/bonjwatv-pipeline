...
namespace bwkt_webapp.Pages.Admin.CreatorMappings
{
    public class CreateModel : PageModel
    {
        ...
        [BindProperty] public string? Canonical { get; set; }
        ...
        public IActionResult OnPost()
        {
            ...
            if (string.IsNullOrWhiteSpace(Source) || string.IsNullOrWhiteSpace(Canonical))
            {
                Error = "Source and Canonical are required.";
                return Page();
            }
            ...
            try
            {
                ...
                using var msg = new HttpRequestMessage(HttpMethod.Post, $"{apiBase}/admin/creators/mappings")
                {
